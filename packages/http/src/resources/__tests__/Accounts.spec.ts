...
describe('list', () => {
  ...
  describe('list richest accounts', () => {
    ...
    it('lists rich accounts', async () => {
      ...
      expect(accounts.data[0].balance?.floatBalance).toBe(100000000)
      expect(accounts.data[1].address).toBe('rich-address-2')
      expect(accounts.data[1].balance?.floatBalance).toBe(99999999)
      expect(accounts.data[2].address).toBe('rich-address-3')
      expect(accounts.data[2].balance?.floatBalance).toBe(99999998)
    })
  })
})
